...
\reviewer*[1. Gutachten, 2. Gutachten]{Prof. Dr.-Ing Martin Oberlack \and Prof. Dr. rer. nat. Michael Schäfer}
...
\submissiondate{15. August 2023}
\examdate{24. Oktober 2023}
...
\renewcommand*{\SignatureBox}[2][5cm]{\parbox[t]{#1}{\centering\includegraphics[scale=0.06]{CV/signature.png}\vspace{-.4cm}
...
\includepdf[pages=-]{CV/CVDeutsch.pdf}
