...
%%
% The development respository can be found atjajaj
...
% Hablvar de porque es bacan el modelo de fernandez terrazo. Representa una forma simple  y versatil de representar fenomenos que solo serian posibles de predecir utilizando modelos quimicos muchos mas complejos, como por ejemplo el leakage. Haciendo uso de una unica ecuacion quimica, es posible estudiar fenomenos complejos de combustion, disminuyendo sustancialmente el costo computacional.  La idea es implementar un modelo versatil, pero a su vez que no brinde mayores complejidades tanto numericas como computacionales. 
