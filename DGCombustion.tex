...
\Crefname{pluralequation}{Equations}{Equations}
\crefformat{pluralequation}{#2equations~(#1)#3}
\Crefformat{pluralequation}{#2Equations~(#1)#3}
...
\title{A Fully Coupled Discontinuous Galerkin Method for Low-Mach Diffusion Flames}
% \subtitle{}
\author[J. Gutiérrez-Jorquera]{Juan Francisco Gutiérrez Jorquera}%optionales Argument ist die Signatur,
\birthplace{Ñuñoa, Santiago de Chile}%Geburtsort, bei Dissertationen zwingend notwendig
\reviewer*[Erstreferent, Koreferent]{Prof. Dr.-Ing Martin Oberlack \and Prof. Dr. rer. nat. Michael Schäfer}
...
%TODO: Pregunta=> Preconditioning:cuando se usa? tiene pardiso un precondicionador? kcycle schwarz multigrid method tiene?

%TODO Introduccion: Hacer una introduccion similar a la del paper de Aldo Hennin
%TODO: arreglar los ejes Y de la figura donde se compara xnsec con simple
%TODO hacerle caso a lauritzt en la introduccion. Es necesario mejorar un poco la redacción de la weá
