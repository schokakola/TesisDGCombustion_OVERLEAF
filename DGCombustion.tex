...
%		ymajorgrids,
		...
		\addplot+[no markers, ]table {data/CoFlowFS_FullComparison/UnityLewis/MassFraction0_flamesheet_y10.txt};%\addlegendentry{Flame sheet1}
		\addplot+[no markers, ]table {data/CoFlowFS_FullComparison/UnityLewis/MassFraction0_full_y10.txt}; %\addlegendentry{Finite Chemistry, Le=1}
		\addplot+[no markers, ]table {data/CoFlowFS_FullComparison/NoUnityLewis/MassFraction0_full_y10.txt}; %\addlegendentry{Finite Chemistry, Le!=1}
		\nextgroupplot[title = {$y = 5$}]		
		\addplot+[no markers, ]table {data/CoFlowFS_FullComparison/UnityLewis/MassFraction1_flamesheet_y10.txt};%\addlegendentry{Flame sheet1}
		\addplot+[no markers, ]table {data/CoFlowFS_FullComparison/UnityLewis/MassFraction1_full_y10.txt}; %\addlegendentry{Finite Chemistry, Le=1}
		\addplot+[no markers, ]table {data/CoFlowFS_FullComparison/NoUnityLewis/MassFraction1_full_y10.txt}; %\addlegendentry{Finite Chemistry, Le!=1}
		\nextgroupplot[title = {$y = 5$}]		
		\addplot+[no markers, ]table {data/CoFlowFS_FullComparison/UnityLewis/MassFraction2_flamesheet_y10.txt};%\addlegendentry{Flame sheet1}
		\addplot+[no markers, ]table {data/CoFlowFS_FullComparison/UnityLewis/MassFraction2_full_y10.txt};% \addlegendentry{Finite Chemistry, Le=1}
		\addplot+[no markers, ]table {data/CoFlowFS_FullComparison/NoUnityLewis/MassFraction2_full_y10.txt}; %\addlegendentry{Finite Chemistry, Le!=1}
		\nextgroupplot[title = {$y = 5$}]		
		...
		\addplot+[no markers, ]table {data/CoFlowFS_FullComparison/NoUnityLewis/MassFraction3_full_y10.txt};% \addlegendentry{Finite Chemistry, Le!=1}
	\end{groupplot}
\end{tikzpicture}
\caption{}
\end{figure}
...
\begin{figure}
	\centering
	\pgfplotsset{width=0.5\textwidth, compat=1.3} 
	\begin{tikzpicture} [spy using outlines={chamfered rectangle, magnification=3,  width=4cm, height=4cm, connect spies}]
	\begin{axis}[
		axis on top,
		width= 0.42\textwidth ,
		height= 0.3\textwidth,
%		xmin = 0,xmax=1,
		...
		xlabel = x,
		ylabel = Fuel mass fraction13,
		]
	\addplot+[no markers, ]table {data/CoFlowFS_FullComparison/UnityLewis/MassFraction3_flamesheet_y10.txt};%\addlegendentry{Flame sheet1}
	\addplot+[no markers, ]table {data/CoFlowFS_FullComparison/UnityLewis/MassFraction3_full_y10.txt}; %\addlegendentry{Finite Chemistry, Le=1}
	\addplot+[no markers, ]table {data/CoFlowFS_FullComparison/NoUnityLewis/MassFraction3_full_y10.txt};% \addlegendentry{Finite Chemistry, Le!=1}
		\coordinate (spypoint) at (axis cs:3,0.08);
		\coordinate (magnifyglass) at (axis cs:24.7,0.00);
		\begin{scope}
			\spy [size=4cm] on (spypoint)
