...
In this section, the concept of the flame sheet approximation is introduced, which is used in the solution algorithm to obtain solutions of the finite reaction rate system given by \cref{eq:LowMach_Conti,eq:LowMach_Momentum,eq:LowMachEnergy,eq:LowMachMassBalance}. The ideas proposed in the work of \textcite{keyesFlameSheetStarting1987} are followed.
