...
The methods for solving this type of non-linear problems will be shown in \cref{sec:CompMethodology}.
\section{Discontinous Galerkin discretization of the low-Mach equations}
