	...
	\begin{tikzpicture}[
		...
		\begin{axis}[
			...
			\addplot+[no markers, ]table {data/CoFlowFS_FullComparison/NoUnityLewis/MassFraction3_full_y10.txt};% \addlegendentry{Finite Chemistry,
				\draw[ausschnitt]
				(axis cs:0.0,0.05)coordinate(ul)--
				(axis cs:5.5,0.05)coordinate(ur)--
